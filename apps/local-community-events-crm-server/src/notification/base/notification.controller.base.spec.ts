  ...
  test("POST /notifications", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        notificationDate: CREATE_RESULT.notificationDate.toISOString(),
      ...
      .expect([
        {
          ...
          notificationDate: FIND_MANY_RESULT[0].notificationDate.toISOString(),
  ...
  test("GET /notifications/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        notificationDate: FIND_ONE_RESULT.notificationDate.toISOString(),
